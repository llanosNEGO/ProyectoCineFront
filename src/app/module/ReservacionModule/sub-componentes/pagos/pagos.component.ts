...
export class PagosComponent {
 paymentForm: FormGroup;
  ...
  goBack() {
    const reservation = this.reservationService.getReservationDetails();
    
    // Navegar a reservacion con el estado actual
    this.router.navigate(['/reservacion'], {
      state: {
        movie: reservation.movie,
        cine: reservation.cine,
        format: reservation.format,
        time: reservation.time,
        // Mantener los asientos ya seleccionados
